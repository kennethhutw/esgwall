...
import Router from 'next/router';import { useAccount,
  useConnect,
   useDisconnect,
   useBalance , useContractWrite, usePrepareContractWrite  } from 'wagmi'
          ...
          <div className="flex flex-col text-block overflow-hidden p-8">
           ...
           <div>
            ...
            <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                ...
                <li>
                    <input type="radio" id="usdc-10" name="usdc-amount" value="1"  onChange={(e) => {    console.log("target =========", e.target); e.preventDefault();
                              setAmount(e.target.value) ; }}  className="hidden peer" ></input>
